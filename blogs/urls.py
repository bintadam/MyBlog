...
from blogs.views import search_view, Postlistview,Postdetailview,Contact_form_view,Post_create_view
from blogs.views import  post_update_view,specific_cat_list_view
urlpatterns = [
    # path('', index),
